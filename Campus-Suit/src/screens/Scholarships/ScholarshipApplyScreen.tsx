  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <AppInput label="Full name" value={fullName} placeholder='Enter your full name' onChangeText={setFullName} />
        ...
        <View style={styles.inputContainer}>
          <Text style={styles.label}>Have you applied before?</Text>
          <View style={styles.pickerContainer}>
            <Picker
              selectedValue={appliedBefore}
              onValueChange={setAppliedBefore}
              style={styles.picker}
            >
