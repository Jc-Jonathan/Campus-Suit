...
export const ProductDetailScreen: React.FC = () => {
  ...
  const route = useRoute<RouteProp<StoreStackParamList, 'ProductDetail'>>();
          ...
          <View style={styles.actions}>
            ...
            <AppButton
              ...
              onPress={() => {
                ...
                const totalPrice = directCheckoutItems.reduce((sum, item) => sum + (item.newPrice * item.quantity), 0);
                navigation.navigate('Checkout', {
                  cartItems: directCheckoutItems,
                  totalPrice,
                  source: 'product'
                });
              }}
