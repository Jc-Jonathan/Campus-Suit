...
const AdminNotification = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const res = await fetch('https://campus-suit-szub.onrender.com/api/auth/users', {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await fetch(
        'https://campus-suit-szub.onrender.com/api/notifications',
        {
          headers: { Authorization: `Bearer ${userToken}` },
        }
      );
  ...
  const handleSend = async () => {
    ...
    const url = editingId
      ? `https://campus-suit-szub.onrender.com/api/notifications/${editingId}`
      : 'https://campus-suit-szub.onrender.com/api/notifications';
                ...
                onPress={() =>
                  Alert.alert('Confirm', 'Delete notification?', [
                    { text: 'Cancel' },
                    {
                      ...
                      onPress: async () => {
                        await fetch(
                          `https://campus-suit-szub.onrender.com/api/notifications/${item._id}`,
                          {
                            method: 'DELETE',
                            headers: {
                              Authorization: `Bearer ${userToken}`,
