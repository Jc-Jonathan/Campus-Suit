  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (schoolIdDocument && schoolIdDocument.cloudinaryUrl) {
        console.log('📤 Sending Occupation ID URL:', schoolIdDocument.cloudinaryUrl);
        ...
        console.log('⚠️ No Occupation ID document uploaded');
      }
...
<View style={styles.addressContainer}>
        ...
        <AppInput
          label="Occupation ID"
          placeholder='Enter your Ocupation ID (if any)'
          value={program}
          onChangeText={setProgram}
        />
        <AppInput
          label="Year of Occupation"
          placeholder='Enter your Occupation year'
          value={yearOfStudy}
