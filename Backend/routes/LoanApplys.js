...
const { getLoanWithCalculation } = require('../controllers/loanapplication.controller');
...
/* ================= GET LOAN WITH CALCULATION ================= */

router.get('/:id/calculation', getLoanWithCalculation);
